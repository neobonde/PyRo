...
VirtualJoystick.prototype._getOffset = function( el ) {
    var _x = 0;
    var _y = 0;
...
VirtualJoystick.prototype._onMouseDown	= function(event)
{
	...
	// var domRect = this._container.getBoundingClientRect();
	offset = this._getOffset(this._container)
...
VirtualJoystick.prototype._onTouchStart	= function(event)
{
	...
	var offset = this._getOffset(this._container)
	// forward the action
